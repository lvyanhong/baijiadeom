	...
	if($ispost) {
		...
		if (empty($error_msg)) {
			...
			if($_POST['install'] == 'remote') {
				...
				if($ins['error']) {
					die('<script type="text/javascript">alert("链接WQ更新服务器失败, 错误为: ' . $ins['error'] . '！");history.back();</script>');
				}
...
VER;
				...
				if(file_exists(IA_ROOT . '/index.php') && file_exists(IA_ROOT . '/setting.php') && file_exists($verfile)) {
					...
					die('<script type="text/javascript">alert("你正在使用本地安装, 但未下载完整安装包, 请从WQ官网下载完整安装包后重试.");history.back();</script>');
				}
			}
...
<title>分销系统</title>
<link href="./resource/install/install.css" rel="stylesheet" type="text/css" />
	...
	<div class="top">
		...
		<div class="top-link">
			<ul>
				...
				<li><a href="" target="_blank">客服Q：613415358</a></li>
			</ul>
		</div>
	</div>
</div>
	...
	echo <<<EOF
		...
		<div class="pr-agreement">
			...
			<strong>二、协议许可的权利 </strong>
				...
				<p>2、您可以在协议规定的约束和限制范围内修改 WQ 源代码或界面风格以适应您的网站要求。 </p>
			...
			<strong>二、协议规定的约束和限制 </strong>
				...
				<p>4、未经官方许可，禁止在 WQ 的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			...
			<strong>三、有限担保和免责声明 </strong>
				...
				<p>3、电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始确认本协议并安装WQ，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p>
...
EOF;
	...
	<table width="726" border="0" align="center" cellpadding="0" cellspacing="0" class="twbox">
		<tr>
			...
			<td>
				...
				<p><small>在线安装能够直接安装最新版本WQ系统, 如果在线安装困难, 请下载离线安装包后使用本地安装.</small></p>
	...
	<table width="726" border="0" align="center" cellpadding="0" cellspacing="0" class="twbox">
		...
		<tr>
			...
			<td>
				<input name="dbname" id="dbname" type="text" value="fenxiao" class="input-txt" />
			</td>
		</tr>
	</table>
